...
class Pengunjung extends MY_backend
{
	...
	public function dataTable() {
		...
		foreach ($jsonArray['data'] as $index => $json) {
			...
			$jsonArray['data'][$index]['daftar_pengunjung']['foto_pengunjung']="<a title='$size' target='_blank' href='".base_url()."public/daftar_pengunjung_foto_pengunjung/$data'>$data</a>";
...
/* Generated by IndonesiaIT Codeigniter CRUD Generator 2019-07-02 08:16:58 */
/* indonesiait.com */