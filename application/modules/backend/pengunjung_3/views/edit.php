		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('nama_pengunjung'),$list['nama_pengunjung']); ?>" type="text" class="form-control" name="nama_pengunjung" id="nama_pengunjung" placeholder="Nama Pengunjung" size="50">			  
				</div>
				</div>
	
				<div class="form-group">
				  <label for="" class="col-sm-2 control-label">Tanggal Daftar*</label>
				  <div class="col-sm-10"><input value="<?php set_value_edit_text(wd_set_value('tgl_daftar'),$list['tgl_daftar']); ?>" type="text" class="form-control" name="tgl_daftar" id="tgl_daftar" placeholder="Tanggal Daftar" size="10">			  
				</div>
				</div>
				...
				if ($list['foto_pengunjung']=='') {
					...
					if (file_exists("public/daftar_pengunjung_foto_pengunjung/".$list['foto_pengunjung'])) {
						$img=base_url()."public/daftar_pengunjung_foto_pengunjung/".$list['foto_pengunjung'];
					}else{
						$img=$this->config->item("assets")."General/not-found.png";
					}
				}
				?>
					...
					<div style="color: red" id="error_foto_pengunjung"></div>			  
				</div>
				</div>
				  </div><!-- /.box-body -->
...
/* Generated via crud engine by indonesiait.com | 2019-07-02 08:16:58 */
