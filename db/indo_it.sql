...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2019 at 08:36 AM
...
CREATE TABLE `daftarpengunjung` (
  ...
  `foto_pengunjung` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `daftarpengunjung`
--

INSERT INTO `daftarpengunjung` (`id`, `nama_pengunjung`, `tgl_daftar`, `foto_pengunjung`) VALUES
(1, 'Joko Widodo', '2019-07-01', 'jokowi.jpg'),
(2, 'Prabowo Subianto', '2019-07-01', 'prabowo.jpg');
...
('a7b1d82cb264bb3e0e9f67aa49d4cf7ca5a0545c', 1562049252);

-- --------------------------------------------------------

--
-- Table structure for table `sfse`
--

CREATE TABLE `sfse` (
  `id` int(6) UNSIGNED NOT NULL,
  `saf` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Dahsboard', 'fa fa-dashboard', 'dashboard', '0', '10000', 2, 1, 1, NULL),
(2, 'System', 'fa fa-gear', '#', '0', '10000', 3, 0, 1, NULL),
(3, 'Users', 'fa fa-user-plus', '#', '2', '11111', 4, 0, 1, NULL),
(4, 'User', 'fa fa-user', 'users', '3', '11111', 5, 0, 1, NULL),
(5, 'Groups', 'fa fa-users', 'groups', '3', '11111', 6, 0, 1, NULL),
(6, 'Module', 'fa fa-terminal', 'module', '2', '11111', 7, 0, 1, NULL),
(7, 'Data Relation', 'fa fa-archive', 'relation', '2', '10000', 8, 1, 1, NULL),
(8, 'Migration', 'fa fa-hourglass-1', 'migration', '2', '10000', 9, 1, 1, NULL),
(9, 'Backup DB', 'fa fa-database', 'backup', '2', '11111', 10, 0, 1, NULL),
(10, 'Options', 'fa fa-bars', 'options', '2', '11111', 11, 0, 1, NULL),
(16, 'Coba', 'fa fa-circle-o', 'coba', '0', '11111', 12, NULL, 0, 'coba'),
(17, 'Coba2', 'fa fa-circle-o', 'coba2', '0', '11111', 13, NULL, 0, 'sfse'),
(21, 'Daftar Pengunjung', 'fa fa-user', 'daftarpengunjung', '0', '11111', 14, NULL, 0, 'daftarpengunjung');
...
(1, '127.0.0.1', 'super', '$2y$08$s6Ctz9s9wBfAJM1Mf/hZAelLiVOa4MtZUG.4EzD.dl2WJFOaRvaIG', '', 'support@indonesiait.com', '', NULL, NULL, 'Vqh1rHuSW4qI0snfe1E4.u', 1268889823, 1561541917, 1, 'Super', 'Admin', 'ADMIN', '', 1),
